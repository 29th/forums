...
<h1><?php echo T("Online Now"); ?></h1>
      ...
      <table class="AltRows">
         ...
         <tbody>
               <tr>
                  <th><?php
                     echo $this->Form->Radio('Plugins.OnlineNow.Location.Show', "Every", array('value' => 'every', 'selected' => 'selected'));
                  ?></th>
         ...
         <tbody>
               <tr>
                  <th><?php
                     echo $this->Form->Checkbox('Plugins.OnlineNow.Hide', "Hide for non members of the site");
                  ?></th>
               </tr>             
         </tbody>
      </table>
